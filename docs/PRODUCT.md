...
Hermes Agent is a focused, shareable agent workflow.

## What it does

Configure, extend, or contribute to Hermes Agent with explicit local/runtime safety boundaries. Use when the user explicitly requests this capability or a closely related task.
